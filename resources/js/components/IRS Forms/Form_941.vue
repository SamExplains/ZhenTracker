    ...
    methods: {
      ...
      exportToPDF: async function () {
        ...
        if (!validated) {
          ...
          //   this.url = this.url.replace('FORM_941.pdf','FORM_941_2020A.pdf');
          // }

          // Reset Url
          this.url = this.unmodifiedUrl;

          if(this.formTypeSelected === '2020A') {
            this.url = this.url.replace('Form _941_2020A.pdf','Form _941_2020A.pdf');
          }

          if(this.formTypeSelected === '2020J') {
            this.url = this.url.replace('Form _941_2020A.pdf','FORM_941_2020J.pdf');
          }
          ...
          * */
          ...
          // Page 3 Name and EIN IF Conditions IS 2020

          if(this.formTypeSelected === '2020A' || this.formTypeSelected === '2020J') {
            // console.warn('PAGE 3 ACTIVATED!!!!!');
